...
const Blog = () => {
    <div className="col-lg-2 col-sm-6 footer-menus">
        ...
        <ul>
            ...
            <li><a href="https://taibislamdipu.medium.com/" target="_blank" rel="noreferrer">Medium</a></li>
            <li><a href="https://dev.to/taibislamdipu" target="_blank" rel="noreferrer">DEV Community</a></li>
        </ul>
